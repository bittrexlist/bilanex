# Base Url
The base url of bilanex open API can be found [here](doc/endpoint.md)

# bilanex Contract Public Endpoint

## `brokerInfo`

Current bilanex trading rules and symbol information.
